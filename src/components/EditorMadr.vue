<template>
    <v-container
        fluid
        class="editor text-left d-flex flex-column mx-0"
        id="editor-madr"
    >
        <v-sheet
                    ...
                    >
                        <template v-slot:append="">
                            <HelpIcon>
                                ...
                                It should describe the solved problem and the
                                solution concisely. <br />
                                The title is also used as file name, so keep it
                                short and avoid using special characters.
                            </HelpIcon>
                        </template>
                    </v-text-field>
                </v-row>
                ...
                >
                    <div class="d-flex my-0 py-0">
                        <span class="flex-grow-1 align-self-center my-0 py-0">
                            Some fields of this ADR are not displayed in the
                            current mode.
                        </span>
                        <v-btn
                ...
                <v-row class="mt-8 mb-1 mx-0">
                    <h3 style="display: inline-flex">
                        ...
                        <HelpIcon>
                            ...
                            free form using two to three sentences. <br />
                            You may want to articulate the problem in form of a
                            question.
                        </HelpIcon>
                    </h3>
                </v-row>
                    ...
                    <v-row class="mx-0 my-1">
                        <h3 style="display: inline-flex">
                            ...
                            <HelpIcon>
                                ...
                                concerns that influence the decision.
                            </HelpIcon>
                        </h3>
                    </v-row>
