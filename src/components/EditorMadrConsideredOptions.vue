        ...
        <v-row class="mx-0 my-1">
            <h3 style="display: inline-flex">
                ...
                <HelpIcon v-if="mode === 'basic'">
                    ...
                    Only write a concise description. You can add a more
                    detailed description in Professional mode.
                </HelpIcon>
                <HelpIcon v-else>
                    List all considered options. <br />
        ...
        >
            <div class="d-flex my-0 py-0">
                <span class="flex-grow-1 align-self-center my-0 py-0">
                    Some options have a more detailed description that is not
                    displayed in Basic Mode.
                </span>
                <v-btn
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <v-list-item-icon
                            v-show="hoveredOption === item"
                            class="align-center flex-shrink-0"
                        >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <v-icon v-if="editedOptions.includes(item)"
                                        >mdi-check</v-icon
                                    >
                            ...
                            >
                                <h6 class="py-4 pl-4">
                                    <v-row class="mx-0">
                                        Description
                                        <HelpIcon>
                                            Describe the option in free form,
                                            e.g., by giving examples or a
                                ...
                                <div
                                    class="d-flex flex-wrap mx-0 px-0 pb-4 py-0 my-0"
                                >
                                    <div
                                        class="flex-grow-1 mx-0 px-0 py-0 my-0"
                                        style="width: 50%; min-width: 600px"
                                    >
                                        <h6 class="py-4 pl-4">
                                            <v-row class="mx-0">
                                                Good, because ...
                                                <HelpIcon>
                                                    Give arguments supporting
                                                    this option.
                                                </HelpIcon>
                                            </v-row>
                                        </h6>
    ...
    methods: {
        ...
        moveOption(option, newIndex) {
            if (this.adr.consideredOptions.includes(option)) {
                this.adr.consideredOptions.splice(
                    this.adr.consideredOptions.indexOf(option),
                    1
                );
