...
any : ( CHARACTER | LIST_MARKER | HEADING_PREFIX | SUBSUBSUBHEADING_PREFIX) ;
...
HEADING_PREFIX : '# ' ; // Start of a Sub sub heading (e. g. an option section)
SUBSUBHEADING_PREFIX : NEWLINE '### ' ; // Start of a Sub sub heading (e. g. an option section)
SUBSUBSUBHEADING_PREFIX : '###' '#'+  ' ' ; // Start of a Sub sub heading (e. g. an option section)
