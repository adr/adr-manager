...
export default class MADRParser extends antlr4.Parser {
    ...
    static literalNames = [ null, "'Good, because '", "'Bad, because '", 
                            ...
                            "'# '" ];
    static symbolicNames = [ null, null, null, "CHARACTER", "WS", "NEWLINE", 
                             "LIST_MARKER", "STATUS_MARKER", "DATE_MARKER", 
                             "DECIDERS_MARKER", "TECHNICAL_STORY_MARKER", 
	...
	any() {
	    ...
	    try {
	        ...
	        this.state = 235;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << MADRParser.CHARACTER) | (1 << MADRParser.LIST_MARKER) | (1 << MADRParser.HEADING_PREFIX) | (1 << MADRParser.SUBSUBSUBHEADING_PREFIX))) !== 0))) {
...
MADRParser.T__0 = 1;
MADRParser.T__1 = 2;
MADRParser.CHARACTER = 3;
MADRParser.WS = 4;
MADRParser.NEWLINE = 5;
MADRParser.LIST_MARKER = 6;
MADRParser.STATUS_MARKER = 7;
MADRParser.DATE_MARKER = 8;
MADRParser.DECIDERS_MARKER = 9;
MADRParser.TECHNICAL_STORY_MARKER = 10;
...
MADRParser.POSITIVE_CONSEQUENCES_HEADING = 18;
MADRParser.NEGATIVE_CONSEQUENCES_HEADING = 19;
MADRParser.PROS_AND_CONS_OF_THE_OPTIONS_HEADING = 20;
MADRParser.LINKS_HEADING = 21;
